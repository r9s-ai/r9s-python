...
def _render_audio_page(cfg: AppConfig) -> None:
    st.header("Audio")
    ...
    with tts_tab:
        ...
        tts_model = st.text_input("TTS model", value=_get_env_default("R9S_TTS_MODEL", "tts-1"))
    ...
    with transcribe_tab:
        ...
        stt_model = st.text_input("STT model", value=_get_env_default("R9S_STT_MODEL", "whisper-1"))
    ...
    with translate_tab:
        ...
        stt_model = st.text_input("STT model (translate)", value=_get_env_default("R9S_STT_MODEL", "whisper-1"))
...
def main() -> None:
    ...
    with st.sidebar:
        page = st.radio("Page", options=["Chat", "Agents", "Image Generation", "Audio"], index=0)
