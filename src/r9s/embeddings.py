...
class Embeddings(BaseSDK):
    def create(
        ...
        *,
        ...
        :param input: Input text to embed, encoded as a string or array of tokens. Each input is limited to 8192 tokens for current OpenAI embedding models, arrays must be 2048 dimensions or less, and the summed tokens across all inputs must stay within the current OpenAI batch limit.
