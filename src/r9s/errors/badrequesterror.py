...
class SchemasBadRequestErrorErrorTypedDict(TypedDict):
    message: str
    r"""Error message"""
    type: str
    r"""Error type"""
...
class SchemasBadRequestErrorError(BaseModel):
    message: str
    r"""Error message"""
...
SchemasBadRequestErrorStatus = Literal["400",]


class BadRequestErrorData(BaseModel):
    error: SchemasBadRequestErrorError

    status: Optional[SchemasBadRequestErrorStatus] = None


@dataclass(unsafe_hash=True)
class BadRequestError(R9SError):
