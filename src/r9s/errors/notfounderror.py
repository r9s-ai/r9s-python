...
class SchemasNotFoundErrorErrorTypedDict(TypedDict):
    message: str
    r"""Error message"""
    type: str
    r"""Error type"""
...
class SchemasNotFoundErrorError(BaseModel):
    message: str
    r"""Error message"""
...
SchemasNotFoundErrorStatus = Literal["404",]


class NotFoundErrorData(BaseModel):
    error: SchemasNotFoundErrorError

    status: Optional[SchemasNotFoundErrorStatus] = None


@dataclass(unsafe_hash=True)
class NotFoundError(R9SError):
