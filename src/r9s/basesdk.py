...
from r9s._hooks import AfterErrorContext, AfterSuccessContext, BeforeRequestContext
from r9s.utils import RetryConfig, SerializedRequestBody, get_body_content
        ...
        def do():
            ...
            if utils.match_status_codes(error_status_codes, http_res.status_code):
                ...
                if result is not None:
                    ...
                    raise errors.R9SDefaultError("Unexpected error occurred", http_res)
