...
from r9s.models.account_models import (
...
class Account(BaseSDK):
    ...
    def _extract_manage_key(self, manage_key: Optional[str] = None) -> str:
        ...
        if not manage_key:
            raise ValueError("manage_key is required for account requests")
        return manage_key
    ...
    def _handle_error_response(self, http_res) -> Any:
        ...
        if utils.match_response(http_res, "401", "application/json"):
            response_data = unmarshal_json_response(
                errors.AccountAuthenticationErrorData, http_res
            )
    ...
    def usage(
        ...
        *,
        ...
        request = GetAccountUsageRequest(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(AccountUsageResponse, http_res)
    ...
    def balance(
        ...
        *,
        ...
        req = self._build_request(
            method="GET",
            path="/portal/management/balance",
            base_url=base_url,
            url_variables=None,
            request=None,
            request_body_required=False,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(AccountBalanceResponse, http_res)
