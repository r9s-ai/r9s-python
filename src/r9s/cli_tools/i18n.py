...
_STRINGS: Dict[str, Dict[str, str]] = {
    "en": {
        "cli.title": "r9s CLI",
        "cli.tagline": "Chat with r9s, or configure local dev tools to use r9s.",
        ...
        "chat.commands.other": "  other /xxx  Handled by extensions (--ext)",
    ...
    "zh-CN": {
        "cli.title": "r9s CLI",
        "cli.tagline": "与 r9s 对话，或配置本地开发工具接入 r9s。",
        ...
        "chat.commands.other": "  其它 /xxx  交给扩展处理（--ext）",
        "chat.prompt.user": "You> ",
        "chat.prompt.assistant": "Assistant> ",
