...
- gpt-4o-transcribe, gpt-4o-mini-transcribe, gpt-4o-mini-transcribe-2025-12-15: Only support json and text formats
...
| `model`                                                                                                                                               | *str*                                                                                                                                                 | :heavy_check_mark:                                                                                                                                    | Model name. OpenAI currently documents `whisper-1` as the supported translation model                                                                  |
