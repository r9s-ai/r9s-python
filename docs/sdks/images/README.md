...
| `quality`                                                                                                     | [Optional[models.Quality]](../../models/quality.md)                                                           | :heavy_minus_sign:                                                                                            | Model-specific image quality. `auto` lets the provider choose a default; GPT image models use `low`, `medium`, or `high`; DALL-E 3 uses `standard` or `hd`. |
| `response_format`                                                                                             | [Optional[models.ImageGenerationRequestResponseFormat]](../../models/imagegenerationrequestresponseformat.md) | :heavy_minus_sign:                                                                                            | Wrapper format for DALL-E image responses (`url` or `b64_json`). GPT image models always return base64 image data and do not support this parameter. |
| `size`                                                                                                        | [Optional[models.Size]](../../models/size.md)                                                                 | :heavy_minus_sign:                                                                                            | Model-specific output size. GPT image models support `auto`, `1024x1024`, `1024x1536`, or `1536x1024`; DALL-E sizes differ by model. |
| `style`                                                                                                       | [Optional[models.Style]](../../models/style.md)                                                               | :heavy_minus_sign:                                                                                            | DALL-E 3 style hint. Use `vivid` or `natural`. |
...
| `prompt`                                                                            | *str*                                                                               | :heavy_check_mark:                                                                  | A text description of the desired edit or result. Max 32000 chars for GPT image models, 1000 for `dall-e-2`, and 4000 for `dall-e-3`. |
